// ===================================================
// Techno4 Framework 2 - Total Engine
...
// Globals
global.F = global.Total = global.Techno4Total = global.T4Total = {};
...
F.exit = function(signal = 15) {
	...
	if (typeof Flow !== 'undefined' && Flow && Flow.instances) {
...
(function(F) {
	...
	F.nosql = name => F.TNoSQL.nosql(name);
...
// Hardware & Sound Subsystems
F.Serial = require('./serial');
F.Audio = require('./audio');
F.MIDI = require('./midi');
global.Techno4Serial = F.Serial;
global.Techno4Audio = F.Audio;
global.Techno4MIDI = F.MIDI;
...
if (!F.Worker.parentPort && process.mainModule && process.mainModule.path)
